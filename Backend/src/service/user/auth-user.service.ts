...
export class AuthUserService implements IAuthUserService {
    ...
    async login(userCredential: LoginDto): Promise<{ accessToken: string; refreshToken: string; }> {
    ...
    async googleLogin(googleToken: string): Promise<{ accessToken: string; refreshToken: string; }> {
